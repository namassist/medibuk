...
class DentalRecord {
  ...
  factory DentalRecord.fromJson(Map<String, dynamic> json) =>
      _$DentalRecordFromJson(json);

  Map<String, dynamic> toJson() => _$DentalRecordToJson(this);
}
